...
class House:
    ...
    def __str__(self):
        return '{}:В доме еды осталось {}, денег осталось {}. Беспорядка в доме {}'.format(self.__class__.__name__,
...
class Wife(Human):
    ...
    def shopping(self):
        ...
        if self.house.money >= 40:
            self.house.money -= 40
            self.house.food += 40
            print('{} купила 40 еды!'.format(self.name))
        else:
